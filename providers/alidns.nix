...
let
  ...
  name = "alidns";
  listenAddr = "127.2.2.3"; # Mnemonic fragment of AliDNS's 223.5.5.5
  listenPort = 53;
  description = "DNS Proxy for AliDNS";
  ...
  # DDNS configuration - Not applicable for AliDNS
  ddns = {
    enabled = false;
    provider = "";
    domain = "";
