...
let
  ...
  name = "yandex";
  listenAddr = "127.7.7.8"; # Mnemonic related to Yandex's 77.88.x.x
  listenPort = 53;
  description = "DNS Proxy for Yandex DNS";
  ...
  dot = {
    enabled = true;
    upstream = "tls://dns.yandex.ru";
  };
  
  # DoH (DNS over HTTPS) configuration
  doh = {
    enabled = true;
    upstream = "https://dns.yandex.ru/dns-query";
  };
  ...
  # DDNS configuration - Not applicable for Yandex DNS
  ddns = {
    enabled = false;
    provider = "";
    domain = "";
